...
function M.get(config)
  ...
  theme = {
    ...
    NvimInternalError = { fg = p.text, bg = p.love },
    ...
    RedrawDebugComposed = { fg = p.text, bg = p.pine },
    RedrawDebugRecompose = { fg = p.text, bg = p.love },
    ...
    GitSignsCurrentLineBlame = { fg = p.iris },
    ...
    IndentBlanklineChar = { fg = p.surface },
    IndentBlanklineContextChar = { fg = p.lumi },
